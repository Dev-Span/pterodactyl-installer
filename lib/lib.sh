...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/Dev-Span/pterodactyl-installer"}
...
get_latest_release() {
  curl -sL "https://api.github.com/repos/$1/releases/1.11.1" | # Get latest release from GitHub api
